email_domains = [
    'com', 'ru', 'net', 'org', 'de', 'uk', 'jp', 'br', 'pl', 'it', 'fr', 'in', 'ir',
    'au', 'ca', 'nl', 'cz', 'kr', 'es', 'ua', 'co', 'gr', 'za', 'ch', 'se', 'ro',
    'tw', 'at', 'be', 'tr', 'dk', 'vn', 'hu', 'mx', 'no', 'fi', 'cl', 'id', 'il',
    'nz', 'pt', 'my', 'sg', 'sk', 'xyz', 'info', 'online', 'site', 'top', 'app', 'io',
    'me', 'biz', 'edu', 'gov', 'mil', 'int', 'arpa', 'aero', 'asia', 'cat', 'coop',
    'jobs', 'mobi', 'museum', 'name', 'post', 'pro', 'tel', 'travel', 'xxx', 'ac',
